/*
 * this file is copy from : https://lkw.readthedocs.io/en/latest/doc/05_proc_interface.html
 * Module to create a proc entry. The user can read and write to the proc entry.
 *
 * This module contains bugs, neither can you wirte to or read from it !
 */
...
int create_new_proc_entry(void) {
    ...
    if (proc) {
        printk(KERN_INFO "create entry successfully !");
        return 0;
    }
    return -1;
}
