...
/*
 * FIXME: this driver is not safe with concurrent readers or writers.
 * emmmmmmmmmmm 为什么并发不安全的
 */
...
#include <linux/delay.h>	/* udelay */ // emmmmmmmmmmm 这是做什么用的
